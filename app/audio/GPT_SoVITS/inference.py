...
if os.path.exists("./gweight.txt"):
    ...
    gpt_path = os.environ.get(
        "gpt_path", "GPT_SoVITS/pretrained_models/ruanmei.ckpt")
...
if os.path.exists("./sweight.txt"):
    ...
    sovits_path = os.environ.get("sovits_path", "raunmei.pth")
# gpt_path = os.environ.get(
...
def get_tts_wav(ref_wav_path, prompt_text, prompt_language, text, text_language, how_to_cut=i18n("按中文句号。切"), top_k=20, top_p=0.6, temperature=0.6, ref_free = False):
